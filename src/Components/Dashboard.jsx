...
//                                   <i className="bx bxs-user-circle font-size-24"></i>
//                                 </span>
//                               </div>
//                             </div>
//                           </div>
...
//                                   <i className="bx bx bx-building-house font-size-24"></i>
//                                 </span>
//                               </div>
//                             </div>
//                           </div>
...
//         <a href="profile.php" className="text-dark">Satya Prakash</a>
//       </h5>
//       <p className="text-muted mb-0" style={{ color: '#00add2' }}>
//         Fresher 
...
// 															</td>
// 															<td>
//               <h5 className="font-size-14 mb-1"><a href="javascript:void(0);" className="text-dark">Jobs Applied (12)</a></h5>
//               <p className="text-muted mb-0">
//                 <a href="javascript:void(0);" className="text-dark">
//                   <span style={{ color: '#c80064' }}>Shortlisted (2) </span>
//                 </a><br />
//                 <a href="javascript:void(0);" className="text-dark">
//                   <span style={{ color: '#ff0000' }}>Rejected (5)</span>
//                 </a><br />
//                 <a href="javascript:void(0);" className="text-dark">
//                   <span style={{ color: '#008040' }}>Subscription (2) </span>
//                 </a><br />
//                 <a href="javascript:void(0);" className="text-dark">
//                   <span style={{ color: '#009999' }}>Saved Jobs (23)</span>
//                 </a><br />
//                 <a href="javascript:void(0);" className="text-dark">
//                   <span style={{ color: '#ff00ff' }}>Reviews(3) </span>
//                 </a>
//               </p>
//             </td>
// 			<td>
...
//               <a href="javascript:void(0);" className="text-dark">
//                 <span style={{ color: '#008040' }}>Recruiter Message (3) </span>
//               </a><br />
//               <a href="javascript:void(0);" className="text-dark">
//                 <span style={{ color: '#808040' }}>Download Resume <i className="bx bxs-cloud-download"></i> </span>
//               </a><br />
//               <a href="javascript:void(0);" className="text-dark">
//                 <span style={{ color: '#444444' }}>Transaction History (5) </span>
//               </a>
//             </td>
// 														<td>
																
																
// 																<button type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop3" className="btn btn-info waves-effect btn-label waves-light"><i className="bx bx-street-view label-icon "></i> View Details  <span className="badge rounded-pill bg-danger">20</span></button>
...
// 														</tr>
// 														<tr>
// 														<td style={{ color: '#ff8000', fontSize: '15px',
//     fontFamily: 'nunito', }}>
//               RZG000091
//             </td>
//             <td>
//               <h5 className="font-size-14 mb-1">
//                 <a href="" className="text-dark">Satya Prakash</a>
//               </h5>
...
//             <td>
//               <h5 className="font-size-14 mb-1">
//                 <a href="javascript:void(0);" className="text-dark">Jobs Applied (12)</a>
//               </h5>
//               <p className="text-muted mb-0">
//                 <a href="javascript:void(0);" className="text-dark">
//                   <span style={{ color: '#c80064' }}>Shortlisted (2) </span>
...
//                 </a><br />
//                 <a href="javascript:void(0);" className="text-dark">
//                   <span style={{ color: '#c80064' }}>Referred Jobs (1)</span>
//                 </a><br />
//                 <a href="javascript:void(0);" className="text-dark">
//                   <span style={{ color: '#c80064' }}>Reviews(3) </span>
//                 </a><br />
//                 : 5 Min | <span style={{ color: '#f46a6a' }}>Complete Required</span> : 500<br />
//                 <p className="text-muted mb-0">
//                   <i className="bx bx-calendar-event" style={{ color: '#f46a6a' }}></i> <strong>From</strong>  01-01-2021 <strong>to</strong> 02-02-2022
//                 </p>
//               </p>
//             </td>
//             <td>
...
//     <td>
//         <h5 className="font-size-14 mb-1">
//             <a href="profile.php" className="text-dark">Mount Talent Consulting</a>
//         </h5>
//         <p className="text-muted mb-0" style={{ color: '#00add2 !important' }}>Consultant & Recruiter <span className="badge border border-light rounded-circle bg-success p-1"><span className="visually-hidden">Consultant & Recruiter</span></span></p>
//         <p className="text-muted mb-0" style={{ color: '#0080ff !important' }}><i className="bx bx-user font-size-16 align-middle me-1"></i> Sushma Sharma</p>
//         <p className="text-muted mb-0">susma@gmail.com</p>
//         <p className="text-muted mb-0">99986785343</p>
//         <p className="text-muted mb-0"><span style={{ color: '#f46a6a' }}>Member Since</span> | 01-01-2021 </p>
//     </td>
//     <td>
//         <h5 className="font-size-14 mb-1">
//             <a href="javascript:void(0);" className="text-dark">Jobs Posted (12)</a>
//         </h5>
//         <p className="text-muted mb-0">
//             <a href="javascript:void(0);" className="text-dark"><span style={{ color: '#dd006f' }}>Featured Jobs (12) </span></a> <br />
//             <a href="javascript:void(0);" className="text-dark"><span style={{ color: '#8000ff' }}>Premium Jobs (12)</span></a> <br />
//             <a href="javascript:void(0);" className="text-dark"><span style={{ color: '#008040' }}>Shortlisted (2)</span></a> <br />
...
//         <a href="javascript:void(0);" className="text-dark"><span style={{ color: '#808040' }}>Subscription (4)</span></a><br />
//         <a href="javascript:void(0);" className="text-dark"><span style={{ color: '#444444' }}>Transaction History (5) </span></a> <br />
//         <a href="javascript:void(0);" className="text-dark"><span style={{ color: '#c80064' }}>Reviews(3) </span></a>
//     </td>
//                                                        <td>
                                                            
															
// 															<button type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop4" className="btn btn-info waves-effect btn-label waves-light"><i className="bx bx-street-view label-icon "></i> View Details <span className="badge rounded-pill bg-danger">20</span></button>
...
//                                                         </td>
// 														<td>
//     <h5 style={{ fontSize: '14px', marginBottom: '1rem' }}>
//         <a href="profile.php" className="text-dark">Mount Talent Consulting</a>
//     </h5>
//     <p style={{ color: '#00add2 !important', marginBottom: '0' }}>Consultant & Recruiter <span className="badge border border-light rounded-circle bg-success p-1"><span className="visually-hidden">Consultant & Recruiter</span></span></p>
//     <p style={{ color: '#0080ff !important', marginBottom: '0' }}><i className="bx bx-user font-size-16 align-middle me-1"></i> Sushma Sharma</p>
//     <p style={{ marginBottom: '0' }}>susma@gmail.com</p>
//     <p style={{ marginBottom: '0' }} className="text-muted"><span style={{ color: '#f46a6a' }}>Member Since</span> | 01-01-2021 </p>
// </td>
// <td>
//     <h5 style={{ fontSize: '14px', marginBottom: '1rem' }}>
//         <a href="javascript:void(0);" className="text-dark">Jobs Posted (12)</a>
...
// 										<div className="row">
//                                             <div className="col-lg-12">
//                                                 <button type="button" className="btn btn-primary waves-effect btn-label waves-light"><i className="bx bxs-right-arrow-square label-icon"></i> View All Employers</button>
//                                             </div>
//                                         </div>
//                                         {/* ============== */}
// 										<div className="row">
...
//                                                         </td>
// 														<td>
//                                                             <h5 className="font-size-14 mb-1"><a href="" className="text-dark">Mount Talent Consulting</a></h5>
//                                                             <p className="text-muted mb-0" style="color: #00add2 !important">Consultant & Recruiter <span className="badge border border-light rounded-circle bg-success p-1"><span className="visually-hidden">Consultant & Recruiter</span></span></p>
// 																<p className="text-muted mb-0" style="color: #0080ff !important"><i className="bx bx-user font-size-16 align-middle me-1"></i> Sushma Sharma</p>
// 															<p className="text-muted mb-0">susma@gmail.com</p>
// 															<p className="text-muted mb-0">99986785343</p>
...
//                                                         </td>
//                                                         <td>
//                                                             <h5 className="font-size-14 mb-1"><a href="javascript:void(0);" className="text-dark">Jobs Posted (12)</a></h5>
// 															  <p className="text-muted mb-0"><a href="javascript:void(0);" className="text-dark"><span style="color: #dd006f;">Featured Jobs (12) </span></a></p> <br/>
// 															  <a href="javascript:void(0);" className="text-dark"><span style="color: #8000ff;">Premium Jobs (12)</span></a> <br/>
...
//                                                         </td>
// 														<td>
//                                                             <h5 className="font-size-14 mb-1"><a href="profile.php" className="text-dark">Mount Talent Consulting</a></h5>
//                                                             <p className="text-muted mb-0" style="color: #00add2 !important">Consultant & Recruiter <span className="badge border border-light rounded-circle bg-success p-1"><span className="visually-hidden">Consultant & Recruiter</span></span></p>
// 																<p className="text-muted mb-0" style="color: #0080ff !important"><i className="bx bx-user font-size-16 align-middle me-1"></i> Sushma Sharma</p>
// 															<p className="text-muted mb-0">susma@gmail.com</p>
// 															<p className="text-muted mb-0">99986785343</p>
...
//                                                         </td>
// 														<td>
//     <h5 className="font-size-14 mb-1"><a href="#" className="text-dark"> Developer</a></h5>
...
//     <p className="text-muted mb-0" style={{ color: '#0080ff !important' }}>
//         <i className="bx bx-street-view font-size-16 align-middle me-1"></i> Noida( Sector-16A Noida )
//     </p>
...
//     <p className="text-muted mb-0">
//         <a href="javascript:void(0);" className="text-dark"><span style={{ color: '#009999' }}>Rejected (12)</span></a> <br />
//         <a href="javascript:void(0);" className="text-dark"><span style={{ color: '#008040' }}>Shortlisted (2)</span></a> <br />
...
// 														<td>
//                                                             <h5 className="font-size-14 mb-1"><a href="#" className="text-dark"> Developer</a></h5>
// 															 <p className="text-muted mb-0" style="color: #dd006f !important; font-size:12px">Premium Job</p>
//                                                             <p className="text-muted mb-0" style="color: #00add2 !important">₹ 4,25,000 - 9,00,000 P.A.</p>
...
//                                                     </tr>
// 													<tr>
//                                                         <td style="color: #ff8000; font-size: 15px; font-family: nunito">
//                                                             RZG0000113
//                                                         </td>
// 														<td>
...
// 										<div className="row">
//                                             <div className="col-lg-12">
//                                                 <button type="button" className="btn btn-primary waves-effect btn-label waves-light"><i className="bx bxs-right-arrow-square label-icon"></i> View All Jobs</button>
//                                             </div>
//                                         </div>
