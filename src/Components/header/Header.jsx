                    ...
                    <div className="collapse navbar-collapse" id="navbarNav">
                        <ul className="navbar-nav align-self-center py-3 d-flex justify-content-between w-100 d-flex gap-3">
                            <li className="nav-item">
                                <Link className="fs-16 text_black" to="/">Home</Link>
                            </li>
                            <div className="dropdown">
                                <Link className="btn dropdown-toggle p-0 border-0 shadow-none" href="#" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
                                    About Us
                                </Link>

                                <ul className="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                    <li><Link className="dropdown-item fs-16 text_black" to="/about">About Us</Link></li>
                                    <hr className="dropdown-divider ms-3 me-3"></hr>
                                    <li><Link className="dropdown-item fs-16 text_black" to="#">Vision</Link></li>
                                    <hr className="dropdown-divider ms-3 me-3"></hr>
                                    <li><Link className="dropdown-item fs-16 text_black" to="#">Mission</Link></li>
                                    <hr className="dropdown-divider ms-3 me-3"></hr>
                                    <li><Link className="dropdown-item fs-16 text_black" to="#">Milestone</Link></li>

                                </ul>
                            </div>
                            <li className="nav-item">
                                <Link className="fs-16 text_black" to="/product">Product</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="fs-16 text_black" to="#">E- Catalogue</Link></li>

                            <li className="nav-item">
                                <Link className="fs-16 text_black" to="#">Media</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="fs-16 text_black" to="#">Art Gallery</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="fs-16 text_black" to="#">Career</Link>
                            </li>
                ...
                <div className="container">
                    ...
                    <div className="offcanvas offcanvas_toggle offcanvas-start" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
                        ...
                        <div className="offcanvas-body">
                            <li className="nav-item">
                                <Link className="fs-16 text_black p-2" to="/">Home</Link>
                            </li>
                            <div className="dropdown">
                                ...
                                <ul className="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                    <li className="d-block"><Link className="dropdown-item fs-16 text_black" to="/about">About Us</Link></li>

                                    <li className="d-block"><Link className="dropdown-item fs-16 text_black" to="#">Vision</Link></li>

                                    <li className="d-block"><Link className="dropdown-item fs-16 text_black" to="#">Mission</Link></li>

                                    <li className="d-block"><Link className="dropdown-item fs-16 text_black" to="#">Milestone</Link></li>

                                </ul>
                            </div>
                            <li className="nav-item">
                                <Link className="fs-16 text_black p-2" to="/product">Product</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="fs-16 text_black p-2" to="#">E- Catalogue</Link></li>

                            <li className="nav-item">
                                <Link className="fs-16 text_black p-2" to="#">Media</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="fs-16 text_black p-2" to="#">Art Gallery</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="fs-16 text_black p-2" to="#">Career</Link>
                            </li>
                        </div>
                    </div>
                </div>
